...
function Output(args) {
  ...
  if (JSUtil.isValidJSON(args)) {
    ...
    if (args.scriptBuffer && !bufferUtil.isBuffer(args.scriptBuffer)) {
      args.scriptBuffer = new Buffer(args.scriptBuffer, 'hex');
    }
    this.setScript(args.script || args.scriptBuffer);
  }
}
...
Output.prototype.toObject = function toObject() {
  ...
  if (this.script) {
    ...
    obj.scriptBuffer = this._scriptBuffer.toString('hex');
  }
  return obj;
};
